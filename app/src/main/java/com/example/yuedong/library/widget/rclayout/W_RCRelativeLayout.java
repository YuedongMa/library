...
package com.example.yuedong.library.widget.rclayout;
 ...
 * 作者：GcsSloop
 */
public class W_RCRelativeLayout extends RelativeLayout {
    ...
    public W_RCRelativeLayout(Context context) {
        this(context, null);
    }

    public W_RCRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public W_RCRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {

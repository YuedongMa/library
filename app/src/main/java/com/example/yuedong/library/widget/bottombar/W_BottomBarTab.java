...
public class W_BottomBarTab extends FrameLayout {
    ...
    public W_BottomBarTab(Context context, @DrawableRes int icon, CharSequence title, Fragment mfragment) {
        this(context, null, icon, title, mfragment);
    }

    public W_BottomBarTab(Context context, AttributeSet attrs, int icon, CharSequence title, Fragment mfragment) {
        this(context, attrs, 0, icon, title, mfragment);
    }

    public W_BottomBarTab(Context context, AttributeSet attrs, int defStyleAttr, int icon, CharSequence title, Fragment mfragment) {
        super(context, attrs, defStyleAttr);
        init(context, icon, title, mfragment);
    }

    private void init(Context context, int icon, CharSequence title, Fragment mfragment) {
        mContext = context;
        ...
        mIcon.setColorFilter(Color.rgb(201,201,201));
        ...
        mTvTitle.setTextColor(Color.rgb(201,201,201));

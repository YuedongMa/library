...
public class DownloadManager {
     ...
     * @throws IOException
     */
    public File saveFile(Context context, ResponseBody response, final String destFileName, ProgressListener progressListener) throws IOException {

        String destFileDir = context.getExternalFilesDir(null) + File.separator;

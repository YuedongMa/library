package com.example.yuedong.library.widget.valid_bank;
...
public class W_BandCardEditText extends EditText {
    ...
    public W_BandCardEditText(Context context) {
        this(context, null);
    }

    public W_BandCardEditText(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public W_BandCardEditText(Context context, AttributeSet attrs, int defStyleAttr) {

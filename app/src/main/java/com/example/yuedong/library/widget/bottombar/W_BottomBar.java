...
public class W_BottomBar extends LinearLayout {
    private static final int TRANSLATE_DURATION_MILLIS = 200;

    private final Interpolator mInterpolator = new AccelerateDecelerateInterpolator();
    private boolean mVisible = true;

    private List<W_BottomBarTab> mTabs = new ArrayList<>();
    ...
    public W_BottomBar(Context context) {
        this(context, null);
    }

    public W_BottomBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public W_BottomBar(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        addView(shadowView, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
    ...
    public W_BottomBar addItem(final W_BottomBarTab tab) {
     ...
     * 获取 Tab
     */
    public W_BottomBarTab getItem(int index) {
